...
public class Item {
    ...
    public Item(ItemTars itemTars) {
        this.id = itemTars.getId();
        this.itemId = itemTars.getItemId();
        this.quantity = itemTars.getQuantity();
        this.unitPrice = itemTars.getUnitPrice();
    }
    ...
    public ItemTars toTars(){
        ItemTars itemTars = new ItemTars();
        itemTars.setId(this.id);
        itemTars.setItemId(this.itemId);
        itemTars.setQuantity(this.quantity);
        itemTars.setUnitPrice(this.unitPrice);
        return itemTars;
    }
}
