...
import works.weave.socks.orders.orderserver.config.OrdersConfigurationProperties;
import works.weave.socks.orders.orderserver.entities.*;
import works.weave.socks.orders.orderserver.repositories.CustomerOrderRepository;
import works.weave.socks.orders.orderserver.resources.NewOrderResource;
import works.weave.socks.orders.orderserver.services.AsyncGetService;
import works.weave.socks.orders.orderserver.values.PaymentRequest;
import works.weave.socks.orders.orderserver.values.PaymentResponse;
